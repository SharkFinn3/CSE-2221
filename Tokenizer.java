...
public class List3<T> extends ListSecondary<T> {
    ...
    public final T removeRightFront() {
        ...
        //Create a new node equals to the rightFront
        Node rightFront = this.lastLeft.next;

        //Data of the rightFront
        T data = rightFront.data;

        //Remove the rightFront
        this.lastLeft.next = rightFront.next;

        //Now lastleft become the previous one next to the rightFront
    ...
    public final void advance() {
        ...
        //rightfront turn to the lastleft
    ...
    public final void moveToStart() {
        ...
        //lastLeft = preStart when left is empty
    ...
    public final void moveToFinish() {
        ...
        // lastLeft = postFinish.previous when right is empty
    ...
    public final void retreat() {
        ...
        //lastleft equals to the lastleft.previous
